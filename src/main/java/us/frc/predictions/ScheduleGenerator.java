...
public class ScheduleGenerator {
  ...
  private static class Schedule {
    final int mNumMatchesPerTeam;
    final int mNumTeams;
    final String[] mSchedule;
    
    Schedule(int pNumMatchesPerTeam, int pNumTeams, String[] pSchedule) {
      mNumMatchesPerTeam = pNumMatchesPerTeam;
      mNumTeams = pNumTeams;
      mSchedule = pSchedule;
    }
    
    public boolean equals(int pNumMatchesPerTeam, int pNumTeams) {
      return pNumMatchesPerTeam == mNumMatchesPerTeam && pNumTeams == mNumTeams;
    }
    
    public boolean equals(Object pOther) {
      if(!(pOther instanceof Schedule)) return false;
      Schedule s = (Schedule)pOther;
      return equals(s.mNumMatchesPerTeam, s.mNumTeams);
    }
    
    // Overriding for speed in the hashset
    public int hashCode() {
      int hash = 31;
      hash += 31 *Integer.hashCode(mNumMatchesPerTeam);
      hash += 31 *Integer.hashCode(mNumTeams);
      return hash;
    }
  }
  
  static {
    ALL_SCHEDULES.add(new Schedule(58, 12, new String[]{
      "51 39 38 5 50 37",
      "34 28 53 10 12 22",
      "6 19 35 40 26 47",
      "18 20 58 55 4 54",
